const Header = () => {
  return (
    <header className="fixed top-0 left-0 w-full h-20 bg-[#8a2b06] text-white flex justify-between items-center px-[10%] shadow-lg z-10">
      ...
      <button className="flex items-center gap-3 bg-[#4d1601] px-6 py-2 rounded-full hover:bg-[#2c0d00] transition">
        <span>🛒</span>
        <span>Your Cart</span>
        <span className="bg-[#b94517] px-3 py-1 rounded-full font-bold">0</span>
      </button>
    </header>
  );
};
